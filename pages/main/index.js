    ...
    <div>
      ...
      <div className="appBody">
        ...
        <div className="swapHeader">
          <span className="swapText">Currency</span>
    ...
    <div className="swapBody">
            <CurrencyField
              ...
              <span className="swapText">
                <img className="manImg" src="https://img.icons8.com/windows/25/FFFFFF/circled-down-2.png"></img>
              </span>
          ...
          <img style={{position: 'absolute', top: 110, left: 90, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center'}} src={'/icea.png'} alt="backgroundleft" />
